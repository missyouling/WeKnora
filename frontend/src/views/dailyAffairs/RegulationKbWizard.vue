<template>
  <t-dialog
    ...
    @close="handleClose"
  >
    <div class="regulation-kb-wizard">
      <!-- 步骤条 -->
      ...
      <div v-if="step === 1" class="wizard-body">
        <div class="setting-row">
          <div class="setting-info">
            ...
            <p class="desc">制度管理固定使用专用知识库，名称不可修改</p>
          </div>
        ...
        <div class="setting-row">
          ...
          <div class="setting-control">
            <t-textarea
              v-model="description"
              :maxlength="200"
              placeholder="用于存放并解析制度文件，自动提取制度字段"
            />
          </div>
        </div>
      </div>
        ...
        <div class="strategy-card">
          <div class="strategy-item">
            ...
            <div class="strategy-info">
              ...
              <p class="strategy-desc">启用向量索引，支持语义检索制度内容</p>
            </div>
          </div>
          <div class="strategy-item">
            <t-checkbox :checked="true" disabled />
            <div class="strategy-info">
              ...
              <p class="strategy-desc">启用关键词索引，支持精确匹配制度编号等信息</p>
            </div>
          </div>
          <div class="strategy-item">
            ...
            <div class="strategy-info">
              ...
              <p class="strategy-desc">制度管理不需要 Wiki 模式</p>
            </div>
          </div>
          <div class="strategy-item">
            <t-checkbox :checked="false" disabled />
            <div class="strategy-info">
              ...
              <p class="strategy-desc">制度管理不需要知识图谱</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div v-if="step === 3" class="wizard-body">
        <div class="model-tip">
          <t-alert theme="info" :message="'提取模型将复用下方「对话模型」，用于解析制度字段。若列表为空，请先在系统设置中添加模型。'" />
        </div>
        <KBModelConfig
          :config="modelConfig"
          :has-files="false"
...
const step = ref(1)
const description = ref('用于存放并解析制度文件，自动提取制度字段')
