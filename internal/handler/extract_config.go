...
func (h *KnowledgeHandler) getExtractConfig(ctx context.Context, kbID, scope, certType string) *types.KbExtractConfig {
...
func (h *KnowledgeHandler) GetExtractConfig(c *gin.Context) {
...
func (h *KnowledgeHandler) SaveExtractConfig(c *gin.Context) {
	ctx := c.Request.Context()
	kbID := secutils.SanitizeForLog(c.Param("id"))
	if kbID == "" {
		c.Error(errors.NewBadRequestError("knowledge base id cannot be empty"))
...
func (h *KnowledgeHandler) TestExtractConfig(c *gin.Context) {
	ctx := c.Request.Context()
	kbID := secutils.SanitizeForLog(c.Param("id"))
	if kbID == "" {
		c.Error(errors.NewBadRequestError("knowledge base id cannot be empty"))
