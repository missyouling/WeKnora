...
func (h *BusinessExtractHandler) resolveFleetScopeByDocType(ctx context.Context, tenantID int64, docType string) string {
...
func (h *BusinessExtractHandler) ExtractFleetDocument(c *gin.Context) {
...
func (h *BusinessExtractHandler) matchVehicleIDByPlate(ctx context.Context, tenantID int64, plate string) string {
...
func (h *BusinessExtractHandler) fleetFieldNames(ctx context.Context, tenantID int64, scope, certType string) []string {
...
func (h *BusinessExtractHandler) syncFleetCategory(ctx context.Context, tenantID int64, scope, docType string, fields map[string]any) {
	docType = strings.TrimSpace(docType)
	if docType == "" {
		return
	}
...
func (h *BusinessExtractHandler) markFleetExtractFailed(ctx context.Context, knowledgeID, scope, certType, errMsg string) {
	failMeta, _ := json.Marshal(fleetDocCustomMetadata{
...
func (h *BusinessExtractHandler) FleetOverviewStats(c *gin.Context) {
	ctx := c.Request.Context()
	kbID := secutils.SanitizeForLog(c.Param("id"))
	if kbID == "" {
